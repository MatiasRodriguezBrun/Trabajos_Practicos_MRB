...
def disyuncion_exclusiva(a, b):
    if a == True and b == True: 
        ...
        resultado = False
        return resultado
print(disyuncion_exclusiva(True, False))
print(disyuncion_exclusiva(False, False))
def xor(a, b):
...
def saludo():
    ...
    return "Hola " + nombre + " bienvenido a python"
print(saludo())
print()
...
def buenas_o_buenos(frase):
    if frase.startswith("Buenos"):
        return "La frase comienza con Buenos"
    elif frase.startswith('Buenas'):
        return "La frase comienza con Buenas"
    else:
        return None
print(buenas_o_buenos("Buenos dias"))
print(buenas_o_buenos("Buenas tardes"))
...
def buena(frase):
    if frase[4] == "a":
        ...
        return "La frase comienza con Buenos"
print (buena("Buenos dias"))
print(buena("Buenas tardes"))
print()
